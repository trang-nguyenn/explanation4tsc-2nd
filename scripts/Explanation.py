...
########################################################
def reshape_lime_explanation(datapath,dataset, LIME_explanation):
...
def load_explanation(datapath,dataset,explanation_type, reshape_lime=False):
    ...
    if reshape_lime:
        weight=reshape_lime_explanation(datapath,dataset,weight)
    return weight
